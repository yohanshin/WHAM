...
tar -xvf dataset/body_models.tar.gz
...
gdown "https://drive.google.com/uc?id=19qkI-a6xuwob9_RFNSPWf1yWErwVVlks&export=download&confirm=t" -O 'checkpoints/hmr2a.ckpt'
